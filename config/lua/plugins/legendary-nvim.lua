...
M.config = function ()
        ...
        { '<leader>sc', legendary_find_filtered(filters.commands), description = 'Legendary: Commands', mode = { 'n', 'v' }},
        { '<leader>sk', legendary_find_filtered(filters.keymaps), description = 'Legendary: Keymaps', mode = { 'n', 'v' }},
        { '<leader>sa', legendary_find_filtered(filters.autocmds), description = 'Legendary: Autocmds', mode = { 'n', 'v' }},
