...
M.config = function()
    ...
    local on_attach = function(args)
        ...
        legendary.keymaps({
            ...
            { 'K', vim.lsp.buf.hover, desc = 'LSP: Hover', opts = opts },
            ...
            { '<leader>cci', telescope_builtin.lsp_incoming_calls, desc = 'LSP: Incoming Calls', opts = opts },
            { '<leader>cco', telescope_builtin.lsp_outgoing_calls, desc = 'LSP: Outgoing Calls', opts = opts },
